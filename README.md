...
**if you want to see the full design . You can go to https://app.shapr3d.com/p/c7965ff8-f383-481d-b931-e097212123b2 . This will lead you to the browser version of the shapr3D where you can download the files if you have the upgraded versions or you can see the throught the design if you don't have it you can take all the stl files from the Assets_3d_printing folder tho and then also do whatever you wanna do with them**
